  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <div className="flex items-center space-x-4 mb-8">
        <Link href="/catalogo" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
        ...
        <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-gray-200">
          <div className="mb-4 flex justify-center">
            <div className="p-4 bg-gray-50 rounded-full">
              <Plus className="w-12 h-12 text-gray-300 rotate-45" />
            </div>
          </div>
          <p className="text-gray-500 mb-6">Tu carrito está vacío</p>
          <Link 
            href="/catalogo"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-white font-semibold transition-transform active:scale-95"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-4">
            ...
            <button 
              ...
              className="w-full py-4 rounded-2xl text-white font-bold text-lg flex items-center justify-center space-x-2 shadow-xl shadow-gray-200 transition-all active:scale-[0.98]"
              style={{ backgroundColor: siteConfig.colors.primary }}
            >
